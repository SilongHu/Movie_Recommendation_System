...
<div class="LoginWindow">
	<div>
		<div class="login">
			...
			<p class="login-submit"><button  type="submit" class="login-button" id ="submit"></button> </p>
		</div>
...
<form name="RegForm" action="regcheck.php" method="post" >
<div class="box">
	<div class="regiest">
		...
		<div id="btn2">
			<ul>
				...
				<li><input type="submit" name="submit"value="提交" class="sumbmit"/></li>
			</ul>
		</div>
	</div>
</div>
